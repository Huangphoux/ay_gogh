#figure(
  image("./static/simplecss.png"),
  caption: [Trang web của thư viện Simple.css.],
)

#set heading(offset: 2)

Simple.css @simplecss là một thư viện CSS được phát triển bởi Kev Quirk, cung cấp một hệ thống thiết kế cho HTML ngữ nghĩa. Dung lượng của Simple.css chỉ 10 KB cực kì nhỏ gọn khi so với các thư viện khác như 144 KB của Bootstrap.
