Đồ án "Xây dựng website hỗ trợ đọc và ghi nhớ từ vựng tiếng Anh bằng AI" tập trung vào việc cải thiện kĩ năng đọc kém và vốn từ vựng nghèo nàn của các bạn học sinh sinh viên hiện nay. Trang web Ay Gogh! được phát triển nhằm cung cấp một nền tảng riêng tư và độc lập để người dùng có thể tập trung vào việc học, tránh việc sao nhãng bằng việc tiếp xúc với những người học khác.

Đề tài được triển khai dựa trên việc nghiên cứu các hệ thống hỗ trợ học ngôn ngữ hiện nay. Từ đó, tác giả đã xác định mục tiêu, phạm vi và các chức năng chính của trang web như: kiểm tra vốn từ vựng căn bản, đọc các bài đọc với độ khó tăng dần, thu thập và ôn tập từ vựng tuỳ ý muốn bất cứ lúc nào.

Về mặt công nghệ, đồ án được thực hiện bằng ngôn ngữ lập trình Python với StarHTML để xử lí yêu cầu đến Back-End, Datastar để điều hướng giao diện phía Front-End, Simple.css để cắt giảm thời gian xây dựng giao diện, và SQLite để lưu trữ dữ liệu. Sử dụng Visual Studio Code để chỉnh sửa mã nguồn.
