...
- Triển khai các bộ từ khác của #link("https://www.newgeneralservicelist.com/")[New General Service List Project
  ...
  - #link("https://www.newgeneralservicelist.com/new-general-service-list-1")[New Academic Word List]: dành cho những người làm việc trong giới học thuật hoặc có nhu cầu dự thi chứng chỉ IELTS học thuật.
